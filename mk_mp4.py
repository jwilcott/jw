...
def convert_to_mp4(input_dir, frame_pattern, fps, output_file, start_frame, end_frame, file_prefix):
    """
...
if __name__ == "__main__":
    ...
    try:
        ...
        convert_to_mp4(input_dir, frame_pattern, fps, output_file, start_frame, end_frame, file_prefix)
